...
from v7_1.read.population_df import indicator_dropdown_options, gini_year_dropdown_options, \
    gini_country_dropdown_options, income_share_country_dropdown_options, perc_pov_indicator_slider_marks, \
    perc_pov_years, perc_pov_year_slider_marks, data_source_url, github_repo_url
from v7_1.utils.make_empty_fig import make_empty_fig
...
primary_layout = html.Div([
    ...
    dbc.Row([
        dbc.Col(lg=1),
        dbc.Col([dcc.Graph(id='perc_pov_scatter_chart', figure=make_empty_fig())], lg=10)
    ]),
