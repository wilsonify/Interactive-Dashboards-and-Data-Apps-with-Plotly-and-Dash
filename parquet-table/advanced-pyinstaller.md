...
1. Run the Python initialization code which prepares everything for running the user's main script.
...
PyInstaller manages lists of files using the ``TOC`` (Table Of Contents) class.
